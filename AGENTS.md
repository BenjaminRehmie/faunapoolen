...
- For ordinary repo work, edit Swedish source pages only. Let the translation script handle English output, unless the user explicitly asks to edit or generate English.
